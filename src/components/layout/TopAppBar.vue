...
<template>
  <MTopAppBar
    ...
    :bordered="true"
    class="md:[&>div>button:first-child]:hidden"
    @navigation="$emit('menuClick')"
  >
    <template #title>
      <div class="flex items-center gap-3">
        ...
        <div class="leading-tight">
          <span class="text-title-medium font-medium text-on-surface">
            M3UI Vue
          </span>
    ...
    <template #actions>
      ...
      >
        ...
        <kbd
          class="rounded border border-outline-variant bg-surface px-1.5 py-0.5 font-mono text-label-small"
        >
          /
        </kbd>
      </button>
      ...
      <div class="hidden items-center sm:flex">
        ...
        <MMenu>
          ...
          <div class="px-4 py-3">
            <p class="mb-3 text-label-large font-medium text-on-surface">
              Color palette
            </p>
        ...
        <MMenu>
          ...
          <div class="px-2 py-2">
            <p class="px-2 text-label-large font-medium text-on-surface">
              Language
            </p>

            <p class="mb-1 px-2 text-label-small text-on-surface-variant">
              Components only — this site's own text stays in English for now
            </p>
      ...
      <div class="sm:hidden">
        <MMenu>
          ...
          <div class="min-w-64 px-2 py-2 flex flex-col">
            <!-- Theme -->
            <button
              type="button"
            ...
            <MMenu>
              ...
              <div class="min-w-56 px-2 py-2">
                ...
                <p class="mb-1 px-2 text-label-small text-on-surface-variant">
                  Components only — this site's own text stays in English for
                  now
                </p>
            ...
            <a
              ...
              target="_blank"
              rel="noopener"
              class="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-body-medium text-on-surface transition-colors hover:bg-on-surface/8"
            >
              <svg
                viewBox="0 0 24 24"
                width="20"
