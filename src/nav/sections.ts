...
const migratedSections = new Set(['/components/buttons', '/components/tables', '/components/feedback', '/components/editors', '/components/overlays', '/components/utility', '/components/advanced', '/components/navigation', '/components/inputs', '/components/layout'])
