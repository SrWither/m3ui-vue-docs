...
import { MSimpleCarousel } from '@m3ui-vue/m3ui-vue'
import type { SimpleCarouselItem } from '@m3ui-vue/m3ui-vue'
...
const carouselProps: PropDef[] = [
  { name: 'items', type: 'SimpleCarouselItem[]', description: 'Slides to render — required' },
...
const carouselItems: SimpleCarouselItem[] = [
...
const carouselMultiRatio: SimpleCarouselItem[] = [
...
<template>
  <div>
    <h1 class="mb-2 text-headline-large font-medium">MSimpleCarousel</h1>
    <p class="mb-8 text-body-large text-on-surface-variant">
      A scroll-snap image carousel with three fixed-width layouts — hero (one protagonist item with
      peeking neighbors), multi-browse (several items at once, statically sized), and uncontained
      (variable-width items, optionally animated by scroll position). For the real M3 multi-browse
      carousel — where items continuously resize as you scroll instead of snapping between fixed
      widths — see <router-link to="/components/data-display/mcarousel" class="text-primary underline">MCarousel</router-link>.
    </p>
    ...
    <ComponentDemo
      ...
      :code="`<MSimpleCarousel :items=&quot;items&quot; layout=&quot;hero&quot; />`"
    >
      <div class="w-full">
        <MSimpleCarousel :items="carouselItems" layout="hero" />
      </div>
    </ComponentDemo>
    ...
    <ComponentDemo
      ...
      :code="`<MSimpleCarousel :items=&quot;items&quot; layout=&quot;multi-browse&quot; :visible-items=&quot;3&quot; />`"
    >
      <div class="w-full">
        <MSimpleCarousel :items="carouselItems" layout="multi-browse" :visible-items="3" />
      </div>
    </ComponentDemo>
    ...
    <ComponentDemo
      ...
      :code="`<MSimpleCarousel :items=&quot;items&quot; layout=&quot;uncontained&quot; />`"
    >
      <div class="w-full">
        <MSimpleCarousel :items="carouselMultiRatio" layout="uncontained" height="260px" />
      </div>
    </ComponentDemo>
    ...
    <ComponentDemo
      ...
      :code="`<MSimpleCarousel :items=&quot;items&quot; layout=&quot;uncontained&quot; :animated=&quot;true&quot; />`"
    >
      <div class="w-full">
        <MSimpleCarousel :items="carouselMultiRatio" layout="uncontained" height="260px" :animated="true" />
      </div>
    </ComponentDemo>
    ...
    <ComponentDemo
      ...
      :code="`<MSimpleCarousel :items=&quot;items&quot; :autoplay=&quot;true&quot; :interval=&quot;3000&quot; />`"
    >
      <div class="w-full">
        <MSimpleCarousel :items="carouselItems" :autoplay="true" :interval="3000" />
      </div>
    </ComponentDemo>
    ...
    <ComponentPager current="MSimpleCarousel" />
  </div>
</template>
