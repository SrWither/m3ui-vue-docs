...
import type { TimelineItem, TreeNode, CarouselItem, LightboxItem } from '@m3ui-vue/m3ui-vue'
...
const lightboxProps: PropDef[] = [
  { name: 'items', type: 'LightboxItem[]', description: '{ src, alt?, caption? } — omit to auto-detect <img> elements rendered in the default slot instead' },
  ...
  { name: 'rounded', type: 'boolean', default: 'true', description: 'Round the corners of the main opened image (thumbnail strip keeps its own fixed rounding)' },
]
...
const nodes = [
  ...
  <MListItem title=&quot;Privacy&quot; icon=&quot;lock&quot; value=&quot;privacy&quot; />
    ...
    <!-- ── MLightbox ───────────────────────────────────────────────────── -->
    <h2 id="mlightbox" class="mb-4 mt-14 text-headline-small font-medium">MLightbox</h2>

    <ComponentDemo
      title="Auto-detected gallery"
      description="Wrap arbitrary content and MLightbox scans it for <img> elements, wiring click-to-open + prev/next navigation automatically — no items array needed."
