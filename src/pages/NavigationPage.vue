...
const railProps: PropDef[] = [
  ...
  { name: 'expanded', type: 'boolean', default: 'false', description: "M3 wide navigation rail's expanded state — items switch from icon-over-label in a narrow centered pill to icon-beside-label in a full-width pill (220px rail)" },
