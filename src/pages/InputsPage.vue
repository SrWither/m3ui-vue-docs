...
<MMaskField v-model=&quot;custom&quot; label=&quot;Custom&quot; mask=&quot;##-###-####&quot; />`"
    ...
    <!-- ── MPinInput ───────────────────────────────────────────────────── -->
    <h2 id="mpininput" class="mb-4 mt-14 text-headline-small font-medium">MPinInput</h2>

    <ComponentDemo
      title="OTP / PIN code"
      description="One box per character. Typing advances to the next box, backspace on an empty box goes back, and pasting a full code fills every box at once — built for 2FA/verification flows."
